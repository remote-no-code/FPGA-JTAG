...
initial begin
    ...
    shift_dmi(DMCONTROL, 32'h00000001, DMI_WRITE);
    ...
    // Read PC
    //----------------------------------------------------------
    $display("\nExecuting Abstract Command : READ PC");

    shift_dmi(COMMAND, 32'h00000001, DMI_WRITE);
    ...
    $display("Expected PC = %08h", dut.debug_pc);
    ...
    shift_dmi(COMMAND, 32'h00000102, DMI_WRITE);
    ...
    shift_dmi(COMMAND, 32'h00000101, DMI_WRITE);
    ...
    shift_dmi(COMMAND, 32'h00000201, DMI_WRITE);
    ...
    shift_dmi(COMMAND, 32'h00000301, DMI_WRITE);
    ...
    shift_dmi(COMMAND, 32'h00000004, DMI_WRITE);
    ...
    shift_dmi(COMMAND, 32'h00000003, DMI_WRITE);
    ...
    shift_dmi(DMCONTROL, 32'h00000002, DMI_WRITE);
    ...
    shift_dmi(DMCONTROL, 32'h00000004, DMI_WRITE);
